package com.santacarolina.mavenproject1.view.fiscaldoc;
...
public class DocDialog extends JDialog {
    ...
    private static final Color MENU_BACKGROUND = new Color(66, 172, 227, 255);
    ...
    private static class SidePanel extends JPanel {
        ...
        private void initComponents(){
            ...
            updateButton = new JButton("Atualizar Documento");
            deleteButton = new JButton("Excluir Documento");
    ...
    private static class MainPanel extends JTabbedPane {
        ...
        private static class InfoPanel extends JPanel {
            ...
            private JPanel northBoxPanel;
            private JPanel centerPanel;
            private JPanel otherPanel;
            private JPanel otherLabelPane;
            private JPanel otherFieldPane;
            ...
            private void initComponents(){
                ...
                northLabelPanel.setLayout(new GridLayout(2,1,10,10));
                ...
                northBoxPanel = new JPanel();
                northBoxPanel.setPreferredSize(new Dimension(500,60));
                northBoxPanel.setLayout(new GridLayout(2,1,10,10));
                ...
                otherLabelPane = new JPanel();
                otherLabelPane.setLayout(new GridLayout(6,1,20,20));
                ...
                otherFieldPane = new JPanel();
                otherFieldPane.setPreferredSize(new Dimension(150,200));
                otherFieldPane.setLayout(new GridLayout(6,1,20,10));
                ...
                otherPanel.setLayout(new FlowLayout(FlowLayout.LEADING));
                ...
                centerPanel.setLayout(new FlowLayout(FlowLayout.LEADING,10,10));
